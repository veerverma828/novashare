...
## Corpus Check
- 26 files · ~19,705 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 136 nodes · 135 edges · 23 communities (19 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b01362bb`
...
2. `scripts` - 6 edges
3. `NotifyDownloadPlugin` - 4 edges
4. `rippleTap()` - 4 edges
5. `App()` - 4 edges
6. `ExampleInstrumentedTest` - 3 edges
7. `MainActivity` - 3 edges
8. `triggerHaptic()` - 3 edges
...
### Community 5 - "App.jsx"
Cohesion: 0.33
Nodes (6): App(), NotifyDownload, rippleTap(), SwipeableFileRow(), initNative(), triggerHaptic()

### Community 7 - "gradlew"
Cohesion: 0.83
Nodes (3): gradlew script, die(), warn()

### Community 8 - "MainActivity.java"
Cohesion: 0.47
Nodes (4): MainActivity, BridgeActivity, Bundle, Override

### Community 9 - "NotifyDownloadPlugin.java"
Cohesion: 0.48
Nodes (5): NotifyDownloadPlugin, CapacitorPlugin, Plugin, PluginCall, PluginMethod
