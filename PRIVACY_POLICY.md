...
**Internet / Network**
Used to establish a direct peer-to-peer connection between two devices. To help two devices find each other, the app uses a third-party connection-assist service called **PeerJS** (`0.peerjs.com`). This service helps set up the initial handshake between devices — it does not see or store the actual files you transfer.
